...
public class RechthoekTest {
	...
	@Test
	public void
			Rechthoek_moet_rechthoek_aanmaken_met_gegeven_linkerbovenhoek_breedte_hoogte_en_straal() {
	...
	@Test
	public void
			equals_moet_true_teruggeven_als_linkerbovenhoek_breedte_hoogte_gelijk_zijn() {
		Rechthoek zelfdeRechthoek = new Rechthoek(
				linkerBovenhoek, breedte, hoogte);
	...
	public void equals_moet_false_teruggeven_als_linkerbovenhoek_verschilt() {
		...
		Rechthoek verschillendeRechthoek = new Rechthoek(
				andereLinkerBovenhoek, breedte, hoogte);
	...
	public void equals_moet_false_teruggeven_als_breedte_verschilt() {
		Rechthoek verschillendeRechthoek = new Rechthoek(
				linkerBovenhoek, breedte + 10, hoogte);
		assertFalse(rechthoek.equals(verschillendeRechthoek));
	}
	...
	public void equals_moet_false_teruggeven_als_hoogte_verschilt() {
		Rechthoek verschillendeRechthoek = new Rechthoek(
				linkerBovenhoek, breedte, hoogte + 10);
		assertFalse(rechthoek.equals(verschillendeRechthoek));
	}
