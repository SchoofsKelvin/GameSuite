...
public class SpelerTest {
	...
	@Test
	public void
			equals_moet_false_teruggeven_als_speler_een_andere_naam_heeft() {
	...
	@Test
	public void
			addtoScore_mag_negatieve_score_toevoegen_als_de_resulterende_score_niet_negatief_wordt() {
		speler.addToScore(positiveScore);
		speler.addToScore(positiveScore);
	...
	@Test(expected = DomainException.class)
	public void
			addToScore_moet_exception_gooien_als_resulterende_score_negatief_wordt() {
		speler.addToScore(negativeScore);
	}
}
